...
class LevelExtractor {
  static Future<Map<int, String>> extractLevels(MapDataStore map) async {
    var bbox = [
      map.boundingBox!.minLongitude,
      map.boundingBox!.maxLongitude,
      map.boundingBox!.minLatitude,
      map.boundingBox!.maxLatitude
    ];
    ...
    var levels = await map.readPoiData(tile1, tile2).then((value) => value!
        .pointOfInterests
